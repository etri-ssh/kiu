...
public class BackgroundDetector implements Application.ActivityLifecycleCallbacks {
    enum State{ None , Foreground, Background}
    private State state;
    private static BackgroundDetector instance = null;
    ...
    public void removeListener() { state = State.None;}
    public boolean isBackground() { return state == State.Background; }
    public boolean isForeground() { return state == State.Foreground; }

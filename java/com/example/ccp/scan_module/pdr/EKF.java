...
import static com.example.sensorlog.scanner.location.GpsLScanner.G_IO;
import static com.example.sensorlog.scanner.location.GpsLScanner.G_IO2;
...
public class EKF {
    ...
    public static void header_EKF(double lat){
        ...
        double p_lat=3.0/Glob_Pos.Rt;  //Lat 오차 공분산 3.0m
        double p_lon=3.0/(Glob_Pos.Rm*Math.cos(lat));  //Lon 오차 공분산 3.0m
        ...
        if(G_IO2<0.6) {
             ...
             r = 0.2 / 6385493.0;  // (WiFi Fingerprinting 오차 표준 편차)/Rt
        }
    ...
    public static void P_pri_Update(double Str,double Head){ // Str : Stride(m) , Head : Heading(rad)
        ...
        Fa[0][3]=-Str*Math.sin(Head)/Glob_Pos.Rm;               //Stride * sin(Heading)/(Rm)
     ...
     //   Fa[1][3]=Str*Math.cos(Head)/(pos_pP[0]);   //Stride * cos(Heading)/(Rt*lat)
        ...
        P_pri[0][0]= P_pr[0][0]*Fa[0][0] + P_pr[0][1]*Fa[0][1] + P_pr[0][2]*Fa[0][2] + P_pr[0][3]*Fa[0][3] + Qc[0][0];
        P_pri[0][1]= P_pr[0][0]*Fa[1][0] + P_pr[0][1]*Fa[1][1] + P_pr[0][2]*Fa[1][2] + P_pr[0][3]*Fa[1][3] + Qc[0][1];
        P_pri[0][2]= P_pr[0][0]*Fa[2][0] + P_pr[0][1]*Fa[2][1] + P_pr[0][2]*Fa[2][2] + P_pr[0][3]*Fa[2][3] + Qc[0][2];
        P_pri[0][3]= P_pr[0][0]*Fa[3][0] + P_pr[0][1]*Fa[3][1] + P_pr[0][2]*Fa[3][2] + P_pr[0][3]*Fa[3][3] + Qc[0][3];

        P_pri[1][0]= P_pr[1][0]*Fa[0][0] + P_pr[1][1]*Fa[0][1] + P_pr[1][2]*Fa[0][2] + P_pr[1][3]*Fa[0][3] + Qc[1][0];
        P_pri[1][1]= P_pr[1][0]*Fa[1][0] + P_pr[1][1]*Fa[1][1] + P_pr[1][2]*Fa[1][2] + P_pr[1][3]*Fa[1][3] + Qc[1][1];
        P_pri[1][2]= P_pr[1][0]*Fa[2][0] + P_pr[1][1]*Fa[2][1] + P_pr[1][2]*Fa[2][2] + P_pr[1][3]*Fa[2][3] + Qc[1][2];
        P_pri[1][3]= P_pr[1][0]*Fa[3][0] + P_pr[1][1]*Fa[3][1] + P_pr[1][2]*Fa[3][2] + P_pr[1][3]*Fa[3][3] + Qc[1][3];

        P_pri[2][0]= P_pr[2][0]*Fa[0][0] + P_pr[2][1]*Fa[0][1] + P_pr[2][2]*Fa[0][2] + P_pr[2][3]*Fa[0][3] + Qc[2][0];
        P_pri[2][1]= P_pr[2][0]*Fa[1][0] + P_pr[2][1]*Fa[1][1] + P_pr[2][2]*Fa[1][2] + P_pr[2][3]*Fa[1][3] + Qc[2][1];
        P_pri[2][2]= P_pr[2][0]*Fa[2][0] + P_pr[2][1]*Fa[2][1] + P_pr[2][2]*Fa[2][2] + P_pr[2][3]*Fa[2][3] + Qc[2][2];
        P_pri[2][3]= P_pr[2][0]*Fa[3][0] + P_pr[2][1]*Fa[3][1] + P_pr[2][2]*Fa[3][2] + P_pr[2][3]*Fa[3][3] + Qc[2][3];

        P_pri[3][0]= P_pr[3][0]*Fa[0][0] + P_pr[3][1]*Fa[0][1] + P_pr[3][2]*Fa[0][2] + P_pr[3][3]*Fa[0][3] + Qc[3][0];
        P_pri[3][1]= P_pr[3][0]*Fa[1][0] + P_pr[3][1]*Fa[1][1] + P_pr[3][2]*Fa[1][2] + P_pr[3][3]*Fa[1][3] + Qc[3][1];
        P_pri[3][2]= P_pr[3][0]*Fa[2][0] + P_pr[3][1]*Fa[2][1] + P_pr[3][2]*Fa[2][2] + P_pr[3][3]*Fa[2][3] + Qc[3][2];
        P_pri[3][3]= P_pr[3][0]*Fa[3][0] + P_pr[3][1]*Fa[3][1] + P_pr[3][2]*Fa[3][2] + P_pr[3][3]*Fa[3][3] + Qc[3][3];

        // P_pri = (P_pri + P_pri')/2

        P_pri[0][0]= (P_pri[0][0]+P_pri[0][0])/2.0;
        P_pri[0][1]= (P_pri[0][1]+P_pri[1][0])/2.0;
        P_pri[0][2]= (P_pri[0][2]+P_pri[2][0])/2.0;
        P_pri[0][3]= (P_pri[0][3]+P_pri[3][0])/2.0;

        P_pri[1][0]= (P_pri[1][0]+P_pri[0][1])/2.0;
        P_pri[1][1]= (P_pri[1][1]+P_pri[1][1])/2.0;
        P_pri[1][2]= (P_pri[1][2]+P_pri[2][1])/2.0;
        P_pri[1][3]= (P_pri[1][3]+P_pri[3][1])/2.0;

        P_pri[2][0]= (P_pri[2][0]+P_pri[0][2])/2.0;
        P_pri[2][1]= (P_pri[2][1]+P_pri[1][2])/2.0;
        P_pri[2][2]= (P_pri[2][2]+P_pri[2][2])/2.0;
        P_pri[2][3]= (P_pri[2][3]+P_pri[3][2])/2.0;

        P_pri[3][0]= (P_pri[3][0]+P_pri[0][3])/2.0;
        P_pri[3][1]= (P_pri[3][1]+P_pri[1][3])/2.0;
        P_pri[3][2]= (P_pri[3][2]+P_pri[2][3])/2.0;
        P_pri[3][3]= (P_pri[3][3]+P_pri[3][3])/2.0;
    ...
    public static double[] EKF_Update(double Str,double Head){
     ...
     //   }
        ...
        dz[0]=pos_pP[0]-pos_wP[0]; //lat Error = PDR_lat (rad) - WiFi_lat (rad)
        dz[1]=pos_pP[1]-pos_wP[1]; //lon Error = PDR_lon (rad) - WiFi_lon (rad)

        Tz=dz[0]*dz[0]+dz[1]*dz[1];
        ...
        //pri_=inv(H_mat*P_pri*H_mat' + Ra)
        double detP=(pri_[0][0]*pri_[1][1])-(pri_[0][1]*pri_[1][0]); //(H_mat*P_pri*H_mat' + Ra) 의 행렬식
        pr_[0][0] = pri_[1][1]/detP;
        pr_[0][1] =-(pri_[0][1]/detP);

        pr_[1][0] =-(pri_[1][0]/detP);
        pr_[1][1] = pri_[0][0]/detP;

        //K =P_pri*H_mat'* pri_ = P_pri*H_mat'*inv(H_mat*P_pri*H_mat' + Ra);
